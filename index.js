      ...
      person.age = 'Thirty' ; // this is the dot notation type to change the value of a property in an object, this is the default method, in JS we can change var type by declaring a dif value
      ...
      sampleArray[4] = 'this is the fifth variable'; // this way we can easily add a new element to the array on the index we set
      sampleArray.push('we will remove this soon'); // this way we can add a new variable to the array at the end
